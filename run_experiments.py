...
def main():
    ...
    run_dataset_exp("kdd","kdd_census.logs",5)            # needs testing (with less rows, but more iterations)
    run_dataset_exp("dutch", "dutch.logs", 5)             # needs testing (with less rows, but more iterations)
