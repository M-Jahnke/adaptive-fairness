...
def main():
    ...
    run_dataset_exp("adult", "adult_census.logs", 5)      # works, pRule only 0.03 lower, acc 0.135 lower!
    run_dataset_exp("kdd","kdd_census.logs",5)            # works
    run_dataset_exp("dutch", "dutch.logs", 5)             # works
